...
document.addEventListener('click', () => {
  document.querySelectorAll(
    '[id^="hr-dd-"],[id^="hr-edit-edu-dd-"],[id^="hr-edit-idoc-dd-"],[id^="hr-edit-dep-dd-"],[id^="hr-edit-sp-dd-"]'
...
function hrEditSpAdd() {
  ...
  if (content) content.innerHTML = `<div class="hr-tab-body">
    <h3 style="color:#777;margin-top:0;">Coming Soon</h3>
    <p>Service Profile Add form will be implemented in Prompt 4.</p>
    <button class="hr-btn-form-cancel" onclick="switchHrEditTab('service-profile')" style="margin-top:8px;">Back</button>
  </div>`;
}
...
function hrEditSpEdit(idx) {
  ...
  if (content) content.innerHTML = `<div class="hr-tab-body">
    <h3 style="color:#777;margin-top:0;">Coming Soon</h3>
    <p>Service Profile Edit form will be implemented in Prompt 4.</p>
    <button class="hr-btn-form-cancel" onclick="switchHrEditTab('service-profile')" style="margin-top:8px;">Back</button>
  </div>`;
}
